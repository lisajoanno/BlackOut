 ...
 * 
 * On change de jeu de couleurs en tapant F3. On choisi la voix en tapant
 * 
 */
public class Preferences {
	...
	public static int MEDIUM_SIZE = 40;
	public static int LARGE_SIZE = 50;

	/** The instance of the singleton. */
	private static Preferences instance;

	/**
	 * liste des classes (i.e. fenêtres) qui vont utiliser ces préférences ces
	 * classes héritent de MenuAbstrait ou DevintFrame
	 * */
	...
	/**
	 * pour changer la couleur on passe d'un jeu prédéfini à un autre
	 */
	...
	public void changeColor() {
		...
		if (Utils.settingsFrame != null)
			Utils.settingsFrame.refreshColorInfo();
	...
	public void changeSize() {
		CurrentSettings.increaseCurrentSize();
		if (currentSize == SMALL_SIZE)
			currentSize = MEDIUM_SIZE;
		else if (currentSize == MEDIUM_SIZE) {
		...
		// -> Ajout d'Antoine
		if (Utils.settingsFrame != null)
			Utils.settingsFrame.refreshSizeInfo();
	}

	// pour changer la voix en passant à la suivante
	public void changeVoice() {
		CurrentSettings.increaseCurrentVoice();
		if (currentVoice == 7)
			currentVoice = 0;
		else
			currentVoice++;
		...
		// -> Ajout d'Antoine
		if (Utils.settingsFrame != null)
			Utils.settingsFrame.refreshVoiceInfo();
	}
	...
	// pour ajouter une fenêtre à la liste des fenêtres dont on peut fixer les
	// préférences
